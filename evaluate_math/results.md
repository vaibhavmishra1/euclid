...
{
  "model": "vibhuiitj/qwen3-4b-base-variant4-feb4-solver-iter3",
  "split": "test",
  "configs": {
    "algebra": {
...
{
  "model": "vibhuiitj/qwen3-4b-base-variant2-feb5-questioner-iter4",
  "split": "test",
  "configs": {
    "algebra": {
